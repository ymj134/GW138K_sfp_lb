...
//Device: GW5AST-138
//Device Version: B
//Created Time: Tue Apr 28 16:12:21 2026
...
wire q1_fabric_ln3_rstn_i;
wire [79:0] q1_fabric_ln3_txdata_i;
wire q1_lane3_pcs_rx_rst;
wire q1_lane3_align_trigger;
wire q1_lane3_chbond_start;
wire q1_lane3_pcs_tx_rst;
wire q1_lane3_fabric_rx_clk;
wire q1_lane3_fabric_c2i_clk;
wire q1_lane3_fabric_tx_clk;
wire q1_lane3_rx_if_fifo_rden;
wire q1_fabric_ln3_tx_vld_in;
...
GTR12_QUAD gtr12_quad_inst1 (
    ...
    .FABRIC_LN3_RSTN_I(q1_fabric_ln3_rstn_i),
    ...
    .FABRIC_LN3_TX_VLD_IN(q1_fabric_ln3_tx_vld_in),
...
RoraLink_8B10B_Top RoraLink_8B10B_Top_inst (
    ...
    .serdes_pcs_tx_rst_o(q1_lane3_pcs_tx_rst),
    .serdes_lanex_fabric_tx_clk_o(q1_lane3_fabric_tx_clk),
    .serdes_lnx_tx_vld_o(q1_fabric_ln3_tx_vld_in),
    .serdes_lnx_txdata_o(q1_fabric_ln3_txdata_i[79:0]),
    .serdes_pcs_rx_rst_o(q1_lane3_pcs_rx_rst),
    .serdes_lanex_fabric_rx_clk_o(q1_lane3_fabric_rx_clk),
    .serdes_lanex_rx_if_fifo_rden_o(q1_lane3_rx_if_fifo_rden),
    .serdes_lanex_fabric_c2i_clk_o(q1_lane3_fabric_c2i_clk),
    .serdes_lanex_chbond_start_o(q1_lane3_chbond_start),
    .serdes_lanex_align_trigger_o(q1_lane3_align_trigger),
    .serdes_lnx_rstn_o(q1_fabric_ln3_rstn_i),
    ...
    .serdes_lanex_tx_if_fifo_afull_i(q1_lane3_tx_if_fifo_afull),
    .serdes_tx_if_fifo_wrusewd_i(q1_lane3_tx_if_fifo_wrusewd[4:0]),
    .serdes_lanex_align_link_i(q1_lane3_align_link),
    .serdes_lanex_k_lock_i(q1_lane3_k_lock),
    .serdes_lnx_pma_rx_lock_i(q1_fabric_ln3_pma_rx_lock_o),
    .serdes_lanex_rx_if_fifo_aempty_i(q1_lane3_rx_if_fifo_aempty),
    .serdes_lnx_rx_vld_i(q1_fabric_ln3_rx_vld_out),
    .serdes_lnx_rxdata_i(q1_fabric_ln3_rxdata_o[87:0]),
    .serdes_rx_if_fifo_rdusewd_i(q1_lane3_rx_if_fifo_rdusewd[4:0]),
    .serdes_q0_cmu1_ok_i(gw_gnd),
    .serdes_q0_cmu0_ok_i(gw_gnd),
    .serdes_q1_cmu1_ok_i(q1_fabric_cmu1_ok_o),
    .serdes_q1_cmu0_ok_i(q1_fabric_cmu_ok_o),
    .serdes_lanex_cmu_ok_i(q1_fabric_lane3_cmu_ok_o),
    .serdes_lanex_pcs_tx_fabric_clk_i(q1_lane3_pcs_tx_o_fabric_clk),
    .serdes_lanex_pcs_rx_fabric_clk_i(q1_lane3_pcs_rx_o_fabric_clk)
);
